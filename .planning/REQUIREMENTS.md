...
- [x] **PERS-01**: Nutzer kann eine Person mit Namen zur Abrechnung hinzufügen
- [x] **PERS-02**: Nutzer kann eine erfasste Person wieder entfernen
- [ ] **PERS-03**: System verhindert eine sinnvolle Abrechnung, solange weniger als zwei Personen erfasst sind

### Ausgaben (EXP)

- [x] **EXP-01**: Nutzer kann eine Ausgabe mit zahlender Person, Beschreibung und Betrag (Euro) erfassen
- [ ] **EXP-02**: Jede Ausgabe ist genau einer erfassten, zahlenden Person zugeordnet
- [x] **EXP-03**: Nutzer kann eine erfasste Ausgabe wieder entfernen
...
- [x] **UI-01**: Nutzer erfasst Personen und Ausgaben auf einer einzigen Seite (kein Routing)
- [x] **UI-02**: Nutzer sieht Gesamtkosten, fairen Anteil, Saldo pro Person und die vorgeschlagenen Ausgleichszahlungen verständlich angezeigt
- [x] **UI-03**: Ungültige Eingaben (negativer Betrag, fehlende zahlende Person, < 2 Personen) werden für den Nutzer nachvollziehbar abgewiesen
